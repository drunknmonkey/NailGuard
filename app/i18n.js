...
const translations = {
  de: {
    ...
    "settings.sensitivityDesc": "Bestimmt, wie früh Tawel auf eine Bewegung reagiert",
    "settings.sensitivityLess": "Weniger Warnungen",
    "settings.sensitivityBalanced": "Ausgewogen",
    "settings.sensitivityEarlier": "Frühere Warnungen",
    ...
    "settings.officeLayout": "Ansicht",
    "settings.officeLayoutDesc": "To-do ist der Standard, Notizen bleiben als Alternative verfügbar",
    ...
    "office.escHintText": "Zurück mit Esc – oder über das X oben rechts",
    "office.todo": "To-do",
    "office.notes": "Notizen",
    "office.today": "Heute",
    "office.todoTitle": "Meine Aufgaben",
    "office.todoPlaceholder": "Aufgabe hinzufügen …",
    "office.todoAdd": "Hinzufügen",
    "office.todoEmpty": "Noch keine Aufgaben. Ein erfreulich leerer Schreibtisch.",
    "office.todoRemove": "Aufgabe „{task}“ entfernen",
    "office.clearCompleted": "Erledigte entfernen",
    "office.taskOne": "1 offene Aufgabe",
    "office.taskOther": "{count} offene Aufgaben",
    "office.exitHint": "Esc zum Beenden",
    ...
    "errors.cameraBusy": "Die Kamera konnte nicht geöffnet werden.",
    "errors.cameraBusyHint1": "Schließe andere Apps oder Tabs, die gerade auf die Kamera zugreifen.",
    "errors.cameraBusyHint2": "Wähle danach „Erneut versuchen“ — ein Neuladen ist nicht nötig.",
    "errors.cameraTimeout": "Der Kamerastart hat zu lange gedauert.",
    "errors.cameraTimeoutHint1": "Wähle „Erneut versuchen“. Tawel setzt den angefangenen Kamerastart dabei vollständig zurück.",
  ...
  en: {
    ...
    "settings.sensitivityDesc": "Controls how early Tawel responds to a movement",
    "settings.sensitivityLess": "Fewer nudges",
    "settings.sensitivityBalanced": "Balanced",
    "settings.sensitivityEarlier": "Earlier nudges",
    ...
    "settings.officeLayout": "View",
    "settings.officeLayoutDesc": "To-do is the default; Notes remains available as an alternative",
    ...
    "office.escHintText": "Leave with Esc — or use the X in the top-right corner",
    "office.todo": "To-do",
    "office.notes": "Notes",
    "office.today": "Today",
    "office.todoTitle": "My tasks",
    "office.todoPlaceholder": "Add a task …",
    "office.todoAdd": "Add",
    "office.todoEmpty": "No tasks yet. A pleasantly clear desk.",
    "office.todoRemove": "Remove task “{task}”",
    "office.clearCompleted": "Clear completed",
    "office.taskOne": "1 open task",
    "office.taskOther": "{count} open tasks",
    "office.exitHint": "Esc to exit",
    ...
    "errors.cameraBusy": "The camera could not be opened.",
    "errors.cameraBusyHint1": "Close other apps or tabs that are currently using the camera.",
    "errors.cameraBusyHint2": "Then choose “Try again” — you do not need to reload the page.",
    "errors.cameraTimeout": "Starting the camera took too long.",
    "errors.cameraTimeoutHint1": "Choose “Try again”. Tawel will fully reset the unfinished camera start.",
